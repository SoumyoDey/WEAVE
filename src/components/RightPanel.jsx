...
export function RightPanel({
  ...
  const lbl = { fontSize: '10px', fontWeight: '700', color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '8px' };
    ...
    <div style={{
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '16px 18px' }}>
        ...
        <div style={{ marginBottom: '22px' }}>
          <div style={lbl}>Colour Scheme</div>
        ...
        {selectedVariable === 'wind' && (
          <div style={{ marginBottom: '22px' }}>
            <div style={lbl}>Wind Overlay</div>
        ...
        {/* ── Uncertainty Overlay ───────────────────────────────────────── */}
        <div style={{ marginBottom: '22px' }}>
          <div style={lbl}>Uncertainty Overlay</div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
            {[
              ...
              { mode: 'bivariate', icon: '🟦', label: 'Bi-Color',   desc: 'Value × uncertainty colour grid' },
        ...
        {uncertaintyMode && uncertaintyMode !== null && (
          <div style={{ marginBottom: '22px' }}>
            <div style={lbl}>Uncertainty Direction</div>
            <button
